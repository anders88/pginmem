...
class CreateSequenceStatement constructor(statementAnalyzer: StatementAnalyzer, private val dbTransaction: DbTransaction) : DbPreparedStatement(dbTransaction) {
