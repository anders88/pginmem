...
import no.anksoft.pginmem.createPreparedStatement
import java.sql.Connection
import java.sql.ResultSet
import java.sql.SQLWarning
import java.sql.Statement

class DbStatement(private val dbTransaction: DbTransaction):Statement {
    ...
    override fun execute(sql: String?): Boolean {
        createPreparedStatement(sql!!,dbTransaction).executeUpdate()
        return false
    }
